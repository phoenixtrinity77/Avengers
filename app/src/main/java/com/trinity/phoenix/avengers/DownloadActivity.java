...
public class DownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdView adView1 = (AdView)findViewById(R.id.avengers9);
        AdView adView2 = (AdView)findViewById(R.id.avengers10);
        AdView adView3 = (AdView)findViewById(R.id.avengers11);
        AdView adView4 = (AdView)findViewById(R.id.avengers12);
        AdView adView5 = (AdView)findViewById(R.id.avengers13);
        AdView adView6 = (AdView)findViewById(R.id.avengers14);
        AdView adView7 = (AdView)findViewById(R.id.avengers15);
        AdView adView8 = (AdView)findViewById(R.id.avengers16);
        AdView adView18 = (AdView)findViewById(R.id.avengers18);
